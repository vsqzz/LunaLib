...
function Luna:CreateWindow(WindowSettings)
	...
	WindowSettings = Kwargify({
		Name = "Nexus",
		Subtitle = "https://discord.gg/VRUsXNkVwk",
		LogoID = "6031097225",
		LoadingEnabled = true,
		LoadingTitle = "Nexus Interface Suite",
		LoadingSubtitle = "by Nexus Hub",
	...
	LoadingFrame.Version.Text = LoadingFrame.Frame.Frame.Title.Text == "Luna Interface Suite" and Release or "Nexus UI"
